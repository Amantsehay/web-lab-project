...
async function loginUser(username, password) {
    try {
        ...
        if (response.ok) {
            ...
            const currentBalanceDiv = document.getElementById('current-bet-amount');
...
async function blockUser(event) {
    ...
    const usernameToBlock = document.getElementById("username-to-block").value;
...
const updatePassword = async (event) => {
    ...
    const confirmPassword = document.getElementById("old-password").value;
...
const updateUsername = async (e) => {
    ...
    const confirmPassword = document.getElementById("password-for-change-username").value;
...
const deleteGame = async (gameUrl, accessToken) => {
    try {
